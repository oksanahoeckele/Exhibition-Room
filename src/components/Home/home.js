...
<<<<<<< HEAD
       <liveVideo/>
        ...
        <div className="item active" >
          <div className="container">
            <div className="row blurb scrollme animateme" data-when="exit"  data-translatey="100">
            ...
            <a href="https://youtu.be/RhFMIRuHAL4" data-vbtype="video" className="venobox btn btn-default">
